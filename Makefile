...
all: library/textureUtility.o car library/levelLoader.o library/settings.o
	$(CC) main.cpp  library/car.o library/textureUtility.o library/levelLoader.o library/settings.o $(LDFLAGS) $(OPTS) -o main
...
lib: library/textureUtility.o library/car.o library/levelLoader.o library/settings.o
